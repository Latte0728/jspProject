...
<div class="container">
	<form name="loginForm" method="post" action="${pageContext.request.contextPath}/j1030/login4Ok">
		<table class="table table-bordered">
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="password" name="pwd" id="pwd" value="1234" class="form-control" autofocus /></td>
			</tr>
			<tr>
				<th>비밀번호</th>
				<td><input type="text" name="nickName" id="nickName" value="" class="form-control" autofocus /></td>
			<tr>
