...
<div class="container">
  ...
  <pre>
    사용용도 : 형식문자열을 지정할때 사용함(쉼표, 화폐단위, 백분율...)
    사용법 : < fmt : 명령어... value="$ {값/변수}" pattern="표현패턴" type="화펴단위" />
  </pre>
  ...
  <div>
    ...
    <fmt:formatNumber value="${34.567}" pattern="#,##0.0" /><br/>
    <hr/>
    ...
    오늘시간5 : <fmt:formatDate value="${today}" pattern="yyyy : MM월 dd일 hh시 mm분 ss초"/><br/>
  	<hr/>
