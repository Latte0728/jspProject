...
<div class="container">
    ...
    <table class="table table-bordered">
  	  ...
  	  <tr>
  	    <td colspan="2" class="text-center">
  	      ...
  	      <input type="button" value="SHA256" onclick="pwdCheck(2)" class="btn btn-primary mr-2" />
  ...
  일반적으로 복호화 할 수 없도록 만든 알고리즘으로, SHA-2라고 하는데,
  이 때 SHA-2가 생성해주는 다이제스트의 출력 길이는 256, 512Bit가 있다.
  여기서 256Bit의 출력 길이를 갖는 SHA-2암호화를 'SHA-256암호화 방식'이라고 한다.
  </pre>
</div>
